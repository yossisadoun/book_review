...
/**
 * HelloAnimation Component
 * @param {string} color - Hex or CSS color for the stroke (default: #ffffff)
 * @param {number} strokeWidth - Width of the line (default: 35)
 * @param {number} duration - Animation duration in seconds (default: 5)
 * @param {string} className - Optional tailwind or CSS classes for the SVG container
 */
      ...
      <style>
        {`
          @keyframes drawHello {
            ...
            20% { stroke-dashoffset: ${dashArray}; }
            100% { stroke-dashoffset: 0; }
          }
          .hello-path {
            stroke-dasharray: ${dashArray};
            stroke-dashoffset: ${dashArray};
            animation: drawHello ${duration}s linear ${delay}s forwards;
          }
        `}
      </style>
      <svg 
