...
import { FileText, MessageCircle, Send, Bookmark, ChevronLeft, ChevronRight } from 'lucide-react';
              ...
              <div className="flex items-center gap-3 px-4 pt-3 pb-2">
                ...
                {articles.length > 1 && (
                  <div className="flex items-center gap-1 flex-shrink-0" onClick={(e) => e.stopPropagation()}>
                    ...
                    <span style={{ color: "#FF007B" }} className="text-[11px] font-semibold">{currentIndex + 1}/{articles.length}</span>
