...
export default function MusicModal({ musicLinks, albumTitle, albumArtist, onClose }: MusicModalProps) {
          ...
          <div className="px-5 pb-4">
            ...
            {albumTitle && (
              <div className="text-center mb-4">
                <p className="text-sm font-bold text-white truncate">{albumTitle}</p>
                {albumArtist && <p className="text-xs text-slate-400 truncate">{albumArtist}</p>}
              </div>
            )}
            {!albumTitle && (
              <p className="text-sm font-bold text-white text-center mb-4">Listen on...</p>
            )}
